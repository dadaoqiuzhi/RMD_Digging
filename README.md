...
# <span style="color: red"> Notice: An upgrade version RMD_Digging_v3.0_dev has been released! This version is more fast and robust, with more practical functions and little bugs. It is also aimed to alleviate the memory consumption in many tasks. Both versions with respective English and Chinese language will be provided. Enjoy it. </span>
